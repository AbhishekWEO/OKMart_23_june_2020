...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.MyViewHolder> {
    ...
    public CategoryAdapter(Context context,List<CategoryData> categoryDataList, HomeFragment homeFragment)
    {
...
//            holder.rl_main.setBackgroundResource(R.drawable.red_rounded_rect);
            holder.tv_catName.setTextColor(context.getResources().getColor(R.color.colorPrimary));
        }
        else
        {

            //Glide.with(context).load(categoryDataList.get(position).getCat_icon()).into(holder.img_cat);
...
//            holder.rl_main.setBackgroundResource(R.drawable.rounded_solid_white);
