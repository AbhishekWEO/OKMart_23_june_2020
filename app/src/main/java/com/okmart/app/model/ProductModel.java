...
public class ProductModel implements Serializable {
    ...
    private String is_resetOrderTime;


    public String getIs_resetOrderTime() {
        return is_resetOrderTime;
    }

    public void setIs_resetOrderTime(String is_resetOrderTime) {
        this.is_resetOrderTime = is_resetOrderTime;
    }
